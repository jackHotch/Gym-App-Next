...
const AddWeightModal = ({ closeModal, change }) => {
  ...
  function convertDate(date) {
    ...
    const formattedDate = newDate.substring(5, 7) + '/' + newDate.substring(8, 10) + '/' + newDate.substring(0, 4)
    return formattedDate
  }

  function updateWeight(e) { setWeight(e.target.value) }

  function toggleCalendar() { setCalendar(!calendar) }
